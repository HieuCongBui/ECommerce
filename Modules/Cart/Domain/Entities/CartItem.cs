namespace Ecommerce.Cart.Domain.Entities
{
    public class CartItem
    {
        ...
        public CartItem(Guid productId, string productName, decimal unitPrice, int quantity, string pictureUrl)
        {
        ...
        {
            if (units <= 0) throw new ArgumentException("Units must be greater than zero");
            Quantity += units;
        }
